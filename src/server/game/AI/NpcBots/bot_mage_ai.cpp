...
public:
    ...
    struct mage_botAI : public bot_minion_ai
    {
        ...
        void CheckSpellSteal(uint32 const diff)
        {
        ...
        void CheckPoly(uint32 const diff)
        {
        ...
        void CheckPots(uint32 const diff)
        {
        ...
        void CheckBlink(uint32 const diff)
        {
        ...
        void FocusMagic(uint32 const diff)
        {
