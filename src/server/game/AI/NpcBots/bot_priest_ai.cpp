...
public:
    ...
    struct priest_botAI : public bot_minion_ai
    {
        ...
        bool MassGroupHeal(Player* player, uint32 const diff)
        {
        ...
        bool ShieldTarget(Unit* target, uint32 const diff)
        {
        ...
        void CheckDispel(uint32 const diff)
        {
        ...
        void CheckShackles(uint32 const diff)
        {
        ...
        void CheckSilence(uint32 const diff)
        {
            if (IsCasting()) return;
            temptimer = GC_Timer;
        ...
        void doDefend(uint32 const diff)
        {
            AttackerSet m_attackers = master->getAttackers();
            AttackerSet b_attackers = me->getAttackers();
        ...
        void DoDevCheck(uint32 const diff)
        {
        ...
        void Disperse(uint32 const diff)
        {
