...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (PlayerbotMgr* mgr = player->GetPlayerbotMgr())
        {
            ...
            {
                if (count == 0)
                    player->ADD_GOSSIP_ITEM(0, "Abandon my Player", REMOVE_PBOT_MENU, GOSSIP_ACTION_INFO_DEF + 100);
                ++count;
            }
        }
        if (count < maxcount && allowPBots)
            player->ADD_GOSSIP_ITEM(0, "Recruit a Player", CREATE_PBOT_MENU, GOSSIP_ACTION_INFO_DEF + 1);
        ...
        if (player->HaveBot())
        {
            ...
            if (count > 0)
                player->ADD_GOSSIP_ITEM(0, "Abandon my Minion", REMOVE_NBOT_MENU, GOSSIP_ACTION_INFO_DEF + 101);
            if (count < maxcount && allowNBots)
                player->ADD_GOSSIP_ITEM(0, "Recruit a Minion", CREATE_NBOT_MENU, GOSSIP_ACTION_INFO_DEF + 2);
        }
        else if (allowNBots)
            player->ADD_GOSSIP_ITEM(0, "Recruit a Minion", CREATE_NBOT_MENU, GOSSIP_ACTION_INFO_DEF + 2);

        player->ADD_GOSSIP_ITEM(0, "Tell me about these bots", INFO_WHISPER, GOSSIP_ACTION_INFO_DEF + 200);
    ...
    static void SendCreatePlayerBotMenu(Player* player, Creature* creature, uint32 /*action*/)
    {
        ...
        player->ADD_GOSSIP_ITEM(9, "ADD ALL" , CREATE_PBOT, GOSSIP_ACTION_INFO_DEF + 1);
        int8 x = 2;
    ...
    {
        player->PlayerTalkClass->ClearMenus();
        player->ADD_GOSSIP_ITEM(9, "REMOVE ALL", REMOVE_PBOT, GOSSIP_ACTION_INFO_DEF + 1);
    ...
    static void SendRemoveNPCBotMenu(Player* player, Creature* creature, uint32 /*action*/)
    {
        ...
        player->ADD_GOSSIP_ITEM(9, "REMOVE ALL", REMOVE_NBOT, GOSSIP_ACTION_INFO_DEF + 1);
    ...
    static void SendCreateNPCBotMenu(Player* player, Creature* creature, uint32 /*action*/)
    {
        ...
        player->PlayerTalkClass->ClearMenus();
        player->ADD_GOSSIP_ITEM(9, "Recruit a Warrior " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 2);
        //player->ADD_GOSSIP_ITEM(9, "Recruit a Hunter " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 3);
        player->ADD_GOSSIP_ITEM(9, "Recruit a Paladin " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 4);
        //player->ADD_GOSSIP_ITEM(9, "Recruit a Shaman " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 5);
        player->ADD_GOSSIP_ITEM(9, "Recruit a Rogue " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 6);
        player->ADD_GOSSIP_ITEM(3, "Recruit a Druid " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 7);
        player->ADD_GOSSIP_ITEM(3, "Recruit a Mage " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 8);
        player->ADD_GOSSIP_ITEM(3, "Recruit a Priest " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 9);
        player->ADD_GOSSIP_ITEM(3, "Recruit a Warlock " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 10);
        //player->ADD_GOSSIP_ITEM(9, "Recruit a Death Knight " + str, CREATE_NBOT, GOSSIP_ACTION_INFO_DEF + 11);
        player->PlayerTalkClass->SendGossipMenu(8446, creature->GetGUID());
    }
