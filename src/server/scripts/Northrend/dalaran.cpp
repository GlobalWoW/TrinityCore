...
class go_memorial_lich_king_movie : public GameObjectScript
{
public:
        go_memorial_lich_king_movie() : GameObjectScript("go_memorial_lich_king_movie") { }
...
void AddSC_dalaran()
{
    ...
    new go_memorial_lich_king_movie;
}
